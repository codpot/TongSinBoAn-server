...
CREATE TABLE IF NOT EXISTS `member` (
  ...
  `mdm_camera` tinyint(1) DEFAULT '0',
  `mdm_mic` tinyint(1) DEFAULT '0',
  `mdm_gps` tinyint(1) DEFAULT '0',
  `mdm_wifi` tinyint(1) DEFAULT '0',
  `mdm_hotspot` tinyint(1) DEFAULT '0',
  `mdm_bluetooth` tinyint(1) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `policy` (
  ...
  `mdm_camera` tinyint(1) DEFAULT '2',
  `mdm_mic` tinyint(1) DEFAULT '2',
  `mdm_gps` tinyint(1) DEFAULT '2',
  `mdm_wifi` tinyint(1) DEFAULT '2',
  `mdm_hotspot` tinyint(1) DEFAULT '2',
  `mdm_bluetooth` tinyint(1) DEFAULT '2',
  PRIMARY KEY (`idx`),
